...
def main():
    ...
    if args.use_cv:
        ...
        for fold_idx, (train_idx, val_idx) in enumerate(kfold.split(X_remaining)):
            ...
            # Train
            train_model(model, train_loader, criterion, optimizer, device, args.epochs, writer, fold_idx * args.epochs, f"Fold {fold_idx + 1}")
    ...
    if args.save:
        ...
        torch.save(save_dict, f'models/mlp_{args.model_name}.pth')
        print(f"Model saved to models/mlp_{args.model_name}.pth\n")
